...
def convert_coco_json(json_dir="../coco/annotations/", use_segments=False, cls91to80=False):
    ...
    save_dir = r'C:\Users\jozon\Downloads\task_task1_annotations_2024_03_28_07_40_52_coco 1.0\YOLO'  # output directory
        ...
        for img_id, anns in tqdm(imgToAnns.items(), desc=f"Annotations {json_file}"):
            ...
            for ann in anns:
                ...
                if box[2] <= 0 or box[3] <= 0:  # if w <= 0 and h <= 0
                    continue
                label_id = ann["category_id"] - 1
                csb_id = [1,2,3,5,6,10,14]
                if label_id not in csb_id:
                    cls = 0
                else:
                    cls = 1  # class
                box = [cls] + box.tolist()
...
if __name__ == "__main__":
    ...
    if source == "COCO":
        convert_coco_json(
            r"C:\Users\jozon\Downloads\task_task1_annotations_2024_03_28_07_40_52_coco 1.0\annotations",  # directory with *.json
            use_segments=True,
            #cls91to80=True,
        )
