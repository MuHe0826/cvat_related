...
if __name__ == "__main__":
    consumables = ["hem_o_lok", "clip", "clamp", "buffer_tube", "guide_needle", "suture_needle", "syringe",
                   "specimen_bag",
                   "cotton_ball", "gauze", "line", "other_consumables"]
    instruments = ["grasping_forceps", "attractor", "needle_holder", "scissors", "ultrasonic_knife", "ultrasonic_clamp",
                   "stapler", "hook", "clip_applicator", "electrotome", "right_angle_grab", "electric_hook",
                   "other_instrument"]
    ...
    for track in tqdm(tracks, desc="Processing", unit="tracks"):
